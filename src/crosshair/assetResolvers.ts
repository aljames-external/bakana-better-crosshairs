 ...
 */
export function resolveCircleAsset(pathOrKey: string | null | undefined, size = 10) {
 ...
 */
export function resolveRectangleAsset(pathOrKey: string | null | undefined, distance = 30, width = 30) {
    const trimmedKey = String(pathOrKey ?? "").trim();
